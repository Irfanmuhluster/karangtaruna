        ...
        <div class="padding-lr">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb hidden-xs">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.categorygallery.index') }}">Kategori</a></li>
...
<div class="card">
    <div class="card-body">
        <div class="d-flex align-items-center justify-content-between justify-content-md-start h-100 px-4">
            <h1> Galeri Kategori </h1>
        </div>
