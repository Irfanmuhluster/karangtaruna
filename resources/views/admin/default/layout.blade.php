...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="worker-src blob:; child-src blob: gap:; img-src 'self' blob: data: {{ url('/') }}; object-src 'self' blob:; default-src * 'self' 'unsafe-inline' 'unsafe-eval' data: gap: content:">
