...
<head>
  ...
  <meta http-equiv="Content-Security-Policy" content="worker-src blob:; child-src blob: gap:; img-src 'self' blob: data:; object-src 'self' blob:; default-src * data: 'unsafe-eval' 'unsafe-inline' data: gap: content:">
