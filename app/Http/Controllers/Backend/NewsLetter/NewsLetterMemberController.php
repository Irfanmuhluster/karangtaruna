...
class NewsLetterMemberController extends Controller
{
    ...
    public function index()
    {
        ...
        $datanewslettermember = $newslettermember->search()
            ->paginate(config('app.setting.backend.no_of_records'));
        $rank = $datanewslettermember->firstItem();
        return view('admin::newsletter.member.index', compact('datanewslettermember','rank'));
    }
